...
namespace RestWithASPNET5.Business.Implementations
{
    public class PersonBusiness : IPersonBusiness
    {
        ...
        public PersonBusiness(IRepository<Person> personRepository, IPersonRepository repository)
        {
        ...
        public List<PersonVO> FindPersonByName(string fristName, string lastName)
        {
            return _converter.Parser(_repository.FindPersonByName(fristName, lastName));
        }
